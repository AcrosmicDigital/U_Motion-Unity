...
{
    [CustomEditor(typeof(TweenTransformLocalRotation))]
    public class TweenTransformLocalRotationInspector : UnityEditor.Editor
    {

        public override void OnInspectorGUI()
        {

            TweenTransformLocalRotation tweenTransform = (TweenTransformLocalRotation)target;
