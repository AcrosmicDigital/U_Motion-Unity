...
public class Utween_TweenFloat_Exceptions
{
    ...
    [UnityTest]
    public IEnumerator TweenFloat_DoestAllowUnexpectedEnd_TaskErrorThrowWhenAnimatorComponentIsDestroyed()
    {
    ...
    public IEnumerator TweenFloat_AllowUnexpectedEnd_TaskErrorDontThowedWhenAnimatorComponentIsDestroyed()
    {
        ...
        var animationParams = new TimeAnimationParams
        {
            ...
            //timeMode = Utween.TimeMode.UnscaledDeltaTime,
            //timingCurve = TimeCurve.easeInOut,
            allowUnexpectedEnd = true,  // Is default value
        };
    ...
    public IEnumerator TweenFloat_AllowUnexpectedEnd_CorroutineDontThrowErrorWhenAnimatorComponentIsDestroyed()
    {
        ...
        var animationParams = new TimeAnimationParams
        {
            ...
            //timeMode = Utween.TimeMode.UnscaledDeltaTime,
            //timingCurve = TimeCurve.easeInOut,
            allowUnexpectedEnd = true, // This is default value
        };
