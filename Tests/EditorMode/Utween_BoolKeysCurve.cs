...
public class Tweens_BoolKeysCurve
{
    ...
    public void BoolKeysCurve_CurveModeSlope()
    {
        ...
        Debug.Log("--> Prueba 1:");
        boolKeysCurve = new BoolKeyframesCurve(keyFrames, UAnimation.KeysCurveMode.Slope);
    ...
    public void BoolKeysCurve_CurveModeStep()
    {
        ...
        Debug.Log("--> Prueba 1:");
        boolKeysCurve = new BoolKeyframesCurve(keyFrames, UAnimation.KeysCurveMode.Step);
        Debug.Log("P: 0 = " + boolKeysCurve.Evaluate(0));
        Assert.AreEqual(false, boolKeysCurve.Evaluate(0));
        Debug.Log("P: .25 = " + boolKeysCurve.Evaluate(.25f));
        Assert.AreEqual(false, boolKeysCurve.Evaluate(.25f));
    ...
    public void BoolKeysCurve_WhenInvalidKeysPassed()
    {
        ...
        Debug.Log("--> Prueba 1:");
        Assert.Throws<ArgumentOutOfRangeException>(() => new BoolKeyframesCurve(keyFrames, UAnimation.KeysCurveMode.Step));
