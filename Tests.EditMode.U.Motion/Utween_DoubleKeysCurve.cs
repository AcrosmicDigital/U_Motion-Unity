...
public class Utween_DoubleKeysCurve
{
    ...
    public void DoubleKeysCurve_CurveModeSlope()
    {
        ...
        DoubleKeysCurve doubleKeysCurve;
        ...
        Debug.Log("--> Prueba 1:");
        doubleKeysCurve = new DoubleKeysCurve(keyFrames, Utween.KeysCurveMode.Slope);
    ...
    public void DoubleKeysCurve_CurveModeStep()
    {
        ...
        Debug.Log("--> Prueba 1:");
        doubleKeysCurve = new DoubleKeysCurve(keyFrames, Utween.KeysCurveMode.Step);
        Debug.Log("P: 0 = " + doubleKeysCurve.Evaluate(0));
        Assert.AreEqual(0d, doubleKeysCurve.Evaluate(0));
        Debug.Log("P: .25 = " + doubleKeysCurve.Evaluate(.25f));
    ...
    public void DoubleKeysCurve_WhenInvalidKeysPassed()
    {
        ...
        DoubleKeysCurve doubleKeysCurve = null;
        Dictionary<int, double> keyFrames;
        ...
        Debug.Log("--> Prueba 1:");
        Assert.Throws<ArgumentOutOfRangeException>(() => new DoubleKeysCurve(keyFrames, Utween.KeysCurveMode.Step));
